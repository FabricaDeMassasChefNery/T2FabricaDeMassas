...
\begin{figure}[h]
    \centering
    \label{fig01}
        \includegraphics[keepaspectratio=true,scale=0.5]{figuras/nivelPortfolioRequisitos.eps}
    \caption{Figura Nível de Portfólio}
\end{figure}

\subsection{Backlog de Portfólio}

Temas de Investimento: Os seguintes temas de investimento foram levantados:\\
\\
\tab T1 - Gestão Administrativa\\
\\
...
Épicos: Para especificação dos Épicos, utilizou-se o padrão recomendados pelo SAFe, que é o template lightweight business case.\\
...
\textbf{Nome do Épico:} Gestão de Pedidos &  \textbf{Data de Entrada do Épico:} 20 de Outubro de 2016\\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{ Patrocinadores: Sem patrocinadores.} \\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{ Usuários e Mercados Afetados: Os usuários serão afetados de modo a poderem comprar diversas massas sem por exemplo sair de casa ou alguma dificuldade em se comunicar com o Chef Nery, haverá uma plataforma online para isso.} \\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{ Produtos, Programas e Serviços Afetados: O serviço de produção e venda dos produtos da Fábrica de Massas poderão ser afetados à medida que um sistema de software desse modelo facilite a aquisição do produto. } \\ \cline{1-2}
\textbf{Investimento Estimado:}90\% dos recursos do grupo &  \textbf{Data de Entrada do Épico:} 20 de Outubro de 2016\\ \cline{1-2}
\textbf{Nome do Épico:} Gestão de Pedidos & Tipo de Retorno: Melhora no sistema de compra e venda do produto, controle de clientes e controle de vendas.\\ \cline{1-2}
\textbf{Data de início:} 24/10/2016 & Data de encerramento: 30/11/2016\\ \cline{1-2}
\end{tabular}
\end{table}
...
\multicolumn{2}{|p{15cm}|}{ Descrição do Épico: A gestão da Exposição da Empresa consiste em um conjunto de atividades relacionadas com a comunicação entre a empresa e o seu cliente. Dentre estas atividades deve se destacar os planos de marketing.} \\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{Critério de Sucesso:
O critério de sucesso desse Épico será definido com 75\% ou mais de cumprimento das features envolvidas.} \\ \cline{1-2}
No Escopo:
 Está no escopo desse Épico Divulgar Canais de Comunicação &  Fora do Escopo: Está fora do escopo aspectos relacionados a Pedidos, Usuários e Produtos.\\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{ Patrocinadores: Sem patrocinadores.} \\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{Usuários e Mercados Afetados: Os usuários serão afetados por conseguirem se comunicar mais facilmente com a fábrica de massa ChefNery. Além disso, os clientes terão uma melhor visão dos produtos da empresa.} \\ \cline{1-2}
\multicolumn{2}{|p{15cm}|}{Produtos, Programas e Serviços Afetados: O serviço de comunicação associada a boas técnicas de marketing pode possibilitar o crescimento no número de clientes.
} \\ \cline{1-2}
\textbf{Investimento Estimado:}10\% dos recursos do grupo &  \textbf{Data de Entrada do Épico:} 20 de Outubro de 2016\\ \cline{1-2}
\textbf{Nome do Épico:} Gestão de Pedidos & Tipo de Retorno:Melhora na imagem, comunicação e marketing da  Empresa.\\ \cline{1-2}
\textbf{Data de início:} 24/10/2016 & Data de encerramento: 30/11/2016\\ \cline{1-2}
\end{tabular}
\end{table}
